...
["remotepuzzletask", "remotepuzzletask.dart", , X, {
  ...
  Contact$fromTouch_closure: {
    ...
    call$1: function(touch) {
      ...
      t1 = this.this_0;
      t2 = H.setRuntimeTypeInfo(new P.Point(touch.pageX, touch.pageY), [null]).x;
      t2.toString;
      t1.touchX = t2;
      t2 = H.setRuntimeTypeInfo(new P.Point(touch.pageX, touch.pageY), [null]).y;
      t2.toString;
      t1.touchY = t2;
      t1.finger = true;
    }
...
function dart_precompiled($collectedClasses) {
  ...
  function Box(x, y, color, id, dragged, imageWidth, imageHeight, touched_x_offset, touched_y_offset, img, rightBuddy, leftBuddy, upperBuddy, lowerBuddy, leftNeighbor, rightNeighbor, upperNeighbor, lowerNeighbor, dragTimer) {
    this.x = x;
    this.y = y;
    this.color = color;
    this.id = id;
    ...
    this.touched_x_offset = touched_x_offset;
    this.touched_y_offset = touched_y_offset;
    this.img = img;
  ...
  function Game(canvas, img, ctx, width, height, myState, box, tmanager, tlayer, score, phaseBreak, clientID, trialNum, flagDraw, touchables, touch_bindings, enabled) {
    this.canvas = canvas;
    this.img = img;
    this.ctx = ctx;
    this.width = width;
  ...
  function State(boxGame, myBoxes, lastLength) {
